  ...
  return <>
    ...
    <main>
      ...
      <section className={styles.serviceOverview}>
        <Reveal className={styles.sectionHeading}><div><span className={styles.eyebrow}>{content.overview.eyebrow}</span><h2>{content.overview.title}</h2></div>{content.overview.description ? <p>{content.overview.description}</p> : null}</Reveal>
      ...
      <section className={styles.processBand}>
        <div><span className={styles.eyebrow}>{content.processIntro.eyebrow}</span><h2>{content.processIntro.title}</h2>{content.processIntro.description ? <p>{content.processIntro.description}</p> : null}</div>
      ...
      <section className={styles.documentsSection}>
        ...
        <div><span className={styles.eyebrow}>{content.documentsIntro.eyebrow}</span><h2>{content.documentsIntro.title}</h2>{content.documentsIntro.description ? <p>{content.documentsIntro.description}</p> : null}<ul>{content.documents.map((document) => <li key={document}><FileText size={17} /> {document}</li>)}</ul></div>
      </section>

      <section className={styles.faqSection}>
        <div><span className={styles.eyebrow}>{content.faqIntro.eyebrow}</span><h2>{content.faqIntro.title}</h2>{content.faqIntro.description ? <p>{content.faqIntro.description}</p> : null}</div>
      ...
      <section className={styles.serviceCta}><div><ClipboardCheck /><span>{content.cta.eyebrow}</span><h2>{content.cta.title}</h2></div><div className={styles.heroActions}><a href="#enquiry" className={styles.primaryButton}>Request consultation <ArrowRight size={18} /></a><Link href="/#services" className={styles.secondaryButton}>View other services</Link></div></section>
    </main>
